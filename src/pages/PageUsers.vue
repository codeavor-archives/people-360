  ...
  <q-page padding>
    <div class="full-width full-height column">
      <template v-if="usersDownloaded">
        ...
        >
          <q-table :filter="filter" title="Treats" :data="data" :columns="columns" row-key="name">
        ...
        <div class="absolute-bottom text-center q-mb-lg no-pointer-events">
          ...
          <q-page-sticky class="all-pointer-events" position="bottom-right" :offset="[18, 18]">
    ...
    <q-dialog v-model="showAddUsers" full-width>
      <addusers></addusers>
    </q-dialog>
  </q-page>
</template>
